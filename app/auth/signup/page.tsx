    ...
    return (
        <main className="bg-white flex justify-center items-center min-h-screen p-6 pt-24">
            <div className='card bg-gray-800 w-96 shadow-xl px-12 py-12'>
                ...
                <input type="text" className="grow text-black" placeholder="example@gmail.com" />
                </label>
                ...
                <label className="input input-bordered flex items-center gap-2 bg-white">
                    ...
                    <input type="text" className="grow text-black" placeholder="John Doe" />
                </label>
                ...
                <input type="password" className="grow text-black" value="" />
                </label>
                <button className='bg-[#ffc519] mt-8 rounded-xl text-black py-3 hover:bg-[#b39232]'>Login</button>
